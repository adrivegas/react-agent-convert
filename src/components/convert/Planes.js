...
export const Planes = () => {
    return (
        ...
        <section className="container mt-5">
            ...
            <h1 className="display-5 text-center mb-5">¡Selecciona el mejor plan para ti!</h1>              
            ...
            <div className= 'p-3 d-flex justify-content-around mb-5'>   
                ...
                <div className="card border-primary mb-3 text-center" style={{maxWidth: '20rem'}}>
                    <div className="card-header"><h4>Básico</h4></div>
                    <div className="card-body">
                        <h4 className="card-title">30 días</h4>
